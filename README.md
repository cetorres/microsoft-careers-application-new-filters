...
Adds a new filter for applications on Screen status to the candidate's [Microsoft careers applications page](https://apply.careers.microsoft.com/careers/applications?domain=microsoft.com).
